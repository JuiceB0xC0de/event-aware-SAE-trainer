...
class RevivalController:
    ...
    def dead_pct(self, window: int) -> float:
        ...
        # Optimization: avoid boolean mask to float casting which creates an intermediate tensor.
        # Direct summation with dtype=torch.float32 is faster and more memory efficient.
    ...
    if start_step == 1:
        ...
        if probe_batch is not None:
            ...
            with torch.no_grad(), _autocast():
                ...
                # Optimization: fuse cast into sum reduction to avoid bfloat16 intermediate accumulation.
